...
public class VideoResponseEntity {
    ...
    public HomeVideoPageModel getPage() {
        return page;
    }

    public void setPage(HomeVideoPageModel page) {
        this.page = page;
    }

    public static class HomeVideoPageModel {
        /**
         * totalCount : 4
         * pageSize : 20
         * totalPage : 1
