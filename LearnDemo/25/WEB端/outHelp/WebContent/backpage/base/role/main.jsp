...
<script type="text/javascript">
	...
	function zTreeOnClick(event, treeId, treeNode) {
	    mainFrame.attr("src","${ctx}/back/role.do?cmd=find&id="+treeNode.id);
	};
	...
	function addNode(obj,pid) {
		...
		mainFrame.attr("src", "${ctx}/back/role.do?cmd=find&id=" + newNodes[0].id);
	}
...
<body>
	...
	<div class="main">
		<div class="maintit">
			<h2>
				<img src="${ctx}/backpage/images/tabicon.gif" width="16" height="16" align="absmiddle" /> 角色管理
			</h2>
			<h3>
