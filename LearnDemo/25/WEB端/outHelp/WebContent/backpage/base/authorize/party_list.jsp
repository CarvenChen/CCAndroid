...
<script type="text/javascript">
	function menuAuthorize(id) {
		var url = "${ctx}/backpage/base/authorize/menu_authorize.jsp?principalid="+id+"&principaltype=party";
...
<body>
	<div class="main">
		<div class="maintit">
			<h2>
				<img src="${ctx}/backpage/images/tabicon.gif" width="16" height="16" align="absmiddle" /> 机构授权
			</h2>
			<h3>
		...
		<div class="centent">
			<div class="search">
				<form id="queryForm" name="queryForm" method="post" action="${ctx}/back/party.do?cmd=list">
					<label> 名称： <input value="${party.name}" id="name" name="username" maxlength="100" class="" /></label>
					<label> 鉴别： <input value="${party.discriminate}" id="discriminate" name="discriminate" maxlength="10" class="" /></label>
